...
All tables can be joined using the File_Number or Case_Number as the primary key.
Quick Start
Prerequisites
•	Python 3.8+
...
bash
git clone https://github.com/your_username/CARDIO-ML_Dataset.git
cd CARDIO-ML_Dataset
